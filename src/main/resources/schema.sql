CREATE TABLE IF NOT EXISTS book (
  bk_num integer NOT NULL AUTO_INCREMENT PRIMARY KEY,
  mb_ID varchar(20),
  mv_num integer,
  tt_num varchar(20),
...
CREATE TABLE IF NOT EXISTS member (
  mb_num integer NOT NULL AUTO_INCREMENT PRIMARY KEY,
  mb_ID varchar(20),
...
CREATE TABLE IF NOT EXISTS movie (
  mv_num integer NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS notice (
  nt_num integer NOT NULL AUTO_INCREMENT PRIMARY KEY,
