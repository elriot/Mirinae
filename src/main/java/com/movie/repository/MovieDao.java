...
public class MovieDao {
	...
	public List<MovieVO>getMoviesForMainPage() {
		List<MovieVO> list = jdbcTemplate.query(/*"select DISTINCT mv_title, mv_rating, mv_detail, mv_releasedate, mv_postimage, mv_trailer from movie where mv_isTrue='T'"*/
				"select * from movie", new BeanPropertyRowMapper<MovieVO>(MovieVO.class));
		return list;
	}
