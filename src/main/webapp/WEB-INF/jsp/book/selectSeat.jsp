...
<div class="container">
	<div class="row">
		...
		<h1 class="text-center">${bookVO.tt_num}번 상영관</h1>
		<hr>
		
		<div id="page-wrapper">
		<form action="payment" method="post" name="frm" id="frm">
	...
	<c:set var="i" value="1"/>
		<c:forEach var="s" items="${list}">
			<c:if test="${i==11}"></tr><tr><td>B</td></c:if>
			<c:if test="${i==21}"></tr><tr><td>C</td></c:if>
			<c:if test="${i==31}"></tr><tr><td>D</td></c:if>
			<c:if test="${i==41}"></tr><tr><td>E</td></c:if>
			<c:if test="${i==51}"></tr><tr><td>F</td></c:if>
			<c:if test="${i==61}"></tr><tr><td>G</td></c:if>
...
<!-- 
	...
	<hr> -->
	<input type="reset" class="waves-effect waves-light btn-large float-left" id="resetSeatNum" value="Reset">
	<input type="submit" class="waves-effect waves-light btn-large float-right" value="Select">
